...
pub use domain::{
    ...
    EditRecipe, EditRecipeRead, EditRecipeSettings, EditRecipeWriteOutcome,
    ExplicitPhotoRemovalMutation, ExplicitPhotoRestoreCounts, ExplicitPhotoRestoreMutation,
    ExplicitPhotoRestoreResult, ExportArtifactFacts, ExportAttempt, ExportExposureRange,
    ExportLeaseOutcome, ExportRecipePayload, ExportRecord, ExportRetryOutcome, ExportSettingsError,
