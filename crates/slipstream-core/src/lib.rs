...
pub use domain::{
    ...
    CheckedPhotoDecisionOutcome, CheckedPhotoDecisionResult, DiscoveredOriginal, EditRecipe,
    EditRecipeRead, EditRecipeSettings, EditRecipeWriteOutcome, MAXIMUM_FOLDER_ALBUM_PHOTOS,
    MAXIMUM_PHOTO_RATING, OriginalErrorCategory, OriginalFacts, OriginalFingerprint, OriginalKind,
    OriginalRecord, OriginalScanError, PHOTO_STATE_BATCH_MAX, PhotoAlbumMembership,
