...
pub use wire::{
    ...
    PhotoRemovalResponse, PhotoRestorationCountsWire, PhotoRestorationResponse, PhotoSummary,
    PreviewResponse, RemovedPhotoWire, RemovedPhotosResponse, ScanStatusWire, SelectionCountsWire,
};
pub(crate) use wire::{
